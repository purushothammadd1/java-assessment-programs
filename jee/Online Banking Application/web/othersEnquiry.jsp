            ...
            <div class="libreg">
                ...
                <c:choose>
                    <c:when test="${status eq 'success'}">
                        <h1 style="color: green; text-align: center">Your Query Send
                            Successfully</h1>

                        <div class="links" style="width: 300px; margin-left: 200px;">
                            <a href="./requestAndEnquiries.html">More Queries</a>
                        </div>
                    ...
                    <c:otherwise>
                        <h1 style="color: red; text-align: center;">Query Send Failed
                        </h1>
                        <div class="links" style="width: 300px; margin-left: 200px;">
                            <a href="./requestAndEnquiries.html">More Queries</a>
                        </div>
