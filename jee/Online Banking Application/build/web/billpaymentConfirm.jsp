...
<html>
    <head>
        ...
        <title>Payments Result Page</title>
        <style>
            body {
                margin: 0px;
                color: white;
...
<!--                        <h1 style="color: green; text-align: center">Transactions Successful</h1>-->
                        ...
                        <div class="links" style="width: 300px; margin-left: 200px;">
                            <a href="./billpayments.html">More Payments</a>
                        </div>

                        <div class="links" style="width: 300px; margin-left: 200px;">
                            <a href="./billpayments.html">Go Back</a>
                        </div>

                    </c:when>
                    <c:otherwise>
                        <h1 style="color: red; text-align: center;">Payment Failed</h1>
