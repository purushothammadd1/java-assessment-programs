...
<!--                        <h1 style="color: green; text-align: center">Transactions Successful</h1>-->
                        <h2 style="text-align: center; color:green; ">${status}</h2> <!-- New line added -->

                        <div class="links" style="width: 300px; margin-left: 200px;">
                            <a href="./transactions.html">Do More Transactions</a>
                        </div>

                        <div class="links" style="width: 300px; margin-left: 200px;">
                            <a href="./customerWindow.jsp">Go Back</a>
                        </div>

                    </c:when>
                    <c:otherwise>
                        <h1 style="color: red; text-align: center;">Transactions Failed</h1>
